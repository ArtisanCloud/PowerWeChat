...
import (
	...
	"github.com/ArtisanCloud/power-wechat/src/work/externalContact/tag/response"
)
...
func (comp *Client) MarkTag(options *request.RequestTagDelStrategyTag) (*response2.ResponseWork, error) {
